      ...
      <ContainerLayout>
        <div className="w-full flex flex-col gap-8 ">
          ...
          <div className="w-full ">
            <div className="w-full flex flex-col max-w-[840px] mx-auto">
              <h1 className="text-customBlack font-bold noto  lg:text-[48px] xl:text-[56px] text-[28px] max-w-[814px] text-center">
                ACIEDafrica’s 4 Thematic Or Core Areas Of Activity
              </h1>
            </div>
          </div>
          {/* lefr side */}
          <div className="w-full grid lg:grid-cols-4 gap-8 mt-8 lg:mt-[60px]">
            {/* start  */}
            <Link
